        ...
        public override void Kill(Edge edge)
        {
            switch (edge.Action)
            {
                ...
                case ArrayDeclaration arrayDeclaration:
                    _constraints.VariableToPossibleAssignments[arrayDeclaration.ArrayName] =
                        new HashSet<(string variable, string startNode, string endNode)>();
                    break;
                ...
                case RecordMemberAssignment recordMemberAssignment:
                    _constraints.VariableToPossibleAssignments[
                ...
                case ReadVariable read:
                    _constraints.VariableToPossibleAssignments[read.VariableName] =
                        new HashSet<(string variable, string startNode, string endNode)>();
                    break;
        ...
        public override void Generate(Edge edge)
        {
            switch (edge.Action)
            {
                case IntDeclaration intDeclaration:
                    ...
                    break;
                case ArrayDeclaration arrayDeclaration:
                    _constraints.VariableToPossibleAssignments[arrayDeclaration.ArrayName].Add((
